...
def get_dataset(dataset, args):
    if dataset.lower() == 'voc':
        ...
        root_path = "/home/liyongjing/Egolee/data/voc/VOCdevkit"        
        train_dataset = gdata.VOCDetection(
            root = root_path,
            splits=[(2007, 'trainval_extract_voc'), (2012, 'trainval_extract_voc'),("VOC_cocotrain2017", 'coco_train'), ("VOC_object365train","object_train"),  ("VOC_object365val","object_val")],
            preload_label=False)
        print(train_dataset.index_map)

        val_dataset = gdata.VOCDetection(
            root = root_path,
            splits=[(2007, 'test_extract_voc'),("VOC_cocoval2017", 'coco_val')],
            preload_label=False) 
