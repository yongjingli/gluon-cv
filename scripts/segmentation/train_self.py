...
gdata.VOCSegmentation.CLASSES = ('background', 'left_side', 'right_side', 'up_circle', 'down_circle')
gdata.VOCSegmentation.BASE_DIR = "seg_oil_meter"
gdata.VOCSegmentation.NUM_CLASS = 5
WIDTH = 640
HEIGHT = 640
...
class Trainer(object):
    def __init__(self, args, logger):
        ...
        trainset = get_segmentation_dataset(args.dataset,
                                            root = "/home/liyongjing/Egolee/data/dataset/voc/VOCdevkit",
        ...
        if args.model_zoo is not None:
            ...
            model = get_segmentation_model(model=args.model, dataset=args.dataset,
                                           backbone=args.backbone, norm_layer=args.norm_layer,
                                           norm_kwargs=args.norm_kwargs, aux=args.aux,
                                           base_size=args.base_size, crop_size=args.crop_size, height=HEIGHT, width=WIDTH)
        ...
        if 'icnet' in args.model:
            ...
            criterion = ICNetLoss(crop_size=args.crop_size, height=HEIGHT, width=WIDTH)
        else:
